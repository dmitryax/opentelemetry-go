module github.com/dmitryax/opentelemetry-go/exporters/otlp/otlptrace/otlptracehttp
...
require (
	...
	github.com/dmitryax/opentelemetry-go/exporters/otlp/otlptrace v1.28.0
...
replace github.com/dmitryax/opentelemetry-go/exporters/otlp/otlptrace => ../
