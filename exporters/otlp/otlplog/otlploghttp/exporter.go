...
package otlploghttp // import "github.com/dmitryax/opentelemetry-go/exporters/otlp/otlplog/otlploghttp"

import (
	"context"
	"sync/atomic"

	"github.com/dmitryax/opentelemetry-go/exporters/otlp/otlplog/otlploghttp/internal/transform"
