...
package internal // import "github.com/dmitryax/opentelemetry-go/internal"
...
//go:generate gotmpl --body=./shared/internaltest/harness.go.tmpl "--data={\"matchersImportPath\": \"github.com/dmitryax/opentelemetry-go/internal/matchers\"}" --out=internaltest/harness.go
